...
// -----------------------------------------------------------------------------
// Funciones MPI usadas en este programa
//
// int MPI_Recv(void *buf_rec, int num, MPI_Datatype datatype, int source,
// int tag, MPI_Comm comm, MPI_Status *status)
//
// buf_rec : puntero al buffer donde se almacenará el dato recibido
// num : número de elementos a recibir
// datatype : tipo de dato de los elementos (ej. MPI_INT)
// source : identificador del proceso emisor (MPI_ANY_SOURCE si da igual)
// tag : etiqueta del mensaje a recibir (MPI_ANY_TAG si da igual)
// comm : comunicador en el que se realiza la comunicación
// status : puntero a estructura MPI_Status para metadatos del mensaje
//
// int MPI_Ssend(void* buf_emi, int count, MPI_Datatype datatype, int dest,
// int tag, MPI_Comm comm)
//
// buf_emi : puntero al buffer con el dato a enviar
// count : número de elementos a enviar
// datatype : tipo de dato de los elementos (ej. MPI_INT)
// dest : identificador del proceso receptor
