...
void funcion_hebra_estanquero(  )
{
   ...
   if(!activista_tumbado && MOSTRADOR!=-1){
...
void proclama_activista(){

   chrono::milliseconds duracion_produ( aleatorio<10,50>() );
...
void funcion_hebra_activista(){
   ...
   while(true){
      ...
      proclama_activista();
      num_proclamas++;
      cout<<"\nnumero de proclamas"<<num_proclamas<<endl;

      if(num_proclamas==8){
         cout<< "\n\n SOY EL ACTIVISTA Y ME TUMBO"<<endl<<endl;
         activista_tumbado=true;
         avisar_activista.sem_wait();
      

         cout<< "\n\n SOY EL ACTIVISTA Y ME LEVANTO"<<endl<<endl;
         cout<< "\n\n JAJAJAJAJAJAJAJ DESTRUIDO EL INGREDIENTE: "<<MOSTRADOR<<endl<<endl;
         MOSTRADOR=-1;
         num_proclamas=0;
         activista_tumbado=false;
         poner_ingredinete.sem_signal();
         cout<<" El activista esta tumbado?"<<activista_tumbado<<endl;
...
int main()
{
   ...
   thread Activista= thread(funcion_hebra_activista);
